...
-- ============================================
-- PREPARACIÓN: ESTRUCTURA Y DATOS
-- ============================================
...
-- ============================================
-- NUEVAS CONSULTAS: SEMANA 05
-- ============================================

-- CONSULTA 1: Filtro con BETWEEN (Rango de mililitros)
SELECT 
...
-- CONSULTA 2: Filtro con IN (Tipos de sangre específicos)
SELECT 
...
-- CONSULTA 3: Búsqueda con LIKE (Patrón de correo)
SELECT 
    full_name AS Nombre, 
    email AS Correo 
FROM donors 
