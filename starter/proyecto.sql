...
-- ============================================
-- PREPARACIÓN: ESTRUCTURA Y DATOS (Semanas 3, 4 y 5)
-- ============================================
...
-- Inserción de 30 Donantes con distribución desigual de tipos de sangre
...
-- Inserción de 30 Donaciones con volúmenes variados
...
(11,1,420,'available'), (12,2,500,'available'), (13,3,450,'available'), (14,4,450,'available'), (15,5,430,'available'),
(16,6,450,'available'), (17,7,500,'available'), (18,8,450,'available'), (19,9,410,'available'), (20,10,480,'available'),
(21,1,450,'available'), (22,2,450,'available'), (23,3,450,'available'), (24,4,500,'available'), (25,5,440,'available'),
...
-- ============================================
-- TODO: Agrupa por la columna de categoría (status)
--       y calcula COUNT + AVG para el volumen de ml
SELECT
...
-- ============================================
-- Identifica tipos de sangre que tienen más de 4 donantes registrados
SELECT
